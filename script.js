		...
		return {
			c() {
				N(i.$$.fragment),
					...
					(s = y("div")),
					(s.innerHTML =
						'<div class="app svelte-1no0zd6">cybertype</div><div class="info svelte-1no0zd6"><div class="app svelte-1no0zd6"><div class="version"> V.1.0</div></div><div class="creator"><p class="svelte-1no0zd6"> Designed by</p><a href="https://discord.com/invite/mTZg5n9Tpz" target="black" class="svelte-1no0zd6"> Blaster</a></div></div>'),
